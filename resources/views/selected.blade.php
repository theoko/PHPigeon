    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Send Email to selected Emails</div>
                ...
                <div class="panel-body">
                  <div class="flash-message">
                    ...
                    <form method="POST" action="{{ route('selected') }}" role="form">
                    ...
                    <div class="col-md-6">
                      <input id="email" type="text" class="form-control" name="email" value="{{ $emails }}" required>
                    </div>
                  </div>
